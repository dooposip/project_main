...
class Tour(db.Model):
    ...
    time = db.Column(db.String(150), nullable=False)                      # 소요 시간 / 필수입력
    price = db.Column(db.String(150), nullable=False)                     # 가격 / 필수입력
    rating = db.Column(db.String(150), nullable=False)                    # 별점 / 필수입력
    level = db.Column(db.String(150), nullable=False)                     # 난이도 / 필수입력
